...
In this doc set, the directory location is _./public_. To open your doc site in a browser, click the `index.html` file in _./public_.
This location can be customized by assigning a new value to the `output > dir` key in the _playbook.yml_ file.
