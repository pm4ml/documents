...
The CA used to sign the Hub's TLS client certificate can be your own self-signed CA or a trusted third-party CA. {connection-wizard} uses the DFSP CA details added here to validate that the Hub TLS client certificate was signed by your CA.
