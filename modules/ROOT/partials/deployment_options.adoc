* **Hosted by System Integrator**: A third-party System Integrator deploy {product-name} in the cloud, and sync up the Core Connector template with the DFSP's core backend implementation.
