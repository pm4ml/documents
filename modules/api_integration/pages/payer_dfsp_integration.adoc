...
The following example shows a response to a `POST /sendmoney` request when the request fails due to the Payee not being found (Step 4 in the diagram above).
